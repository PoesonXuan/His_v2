...
<body>
		...
		<div class="panel-body">
			<div class="container">
				<!-- <form action="#"> -->
					...
					<br /> <br />
					<div class="form-group">
						<label class="col-sm-2 control-label">工单环节</label>
						<div class="col-sm-4">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label">维护详情</label>
						<div class="col-sm-10 ">
							<textarea id="opinion2" class="form-control" rows="3" name="textarea"
								placeholder="说点什么吧">
								${ticket.dealer_desc}
							</textarea>
							<!-- <textarea id="rea"  ></textarea> -->
	...
	<script type="text/javascript">
		$(function() {
			...
			var options = '';
			// 0 待签收 1 待维护  2 审批失败  3 待归档
			if(status && (status =='0' || status ==0)){
				options = '<option value="0">待审核</option>';
			}else if(status && (status =='1' || status ==1)){
				options = '<option value="1">待签收</option>';
			}
