    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">医院信息管理系统</a>
        </div>
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul id="treeNav" class="nav nav-sidebar">
            ...
            <li><a href="#" onclick="home.leftMenu(301)">值日管理</a></li>
            <li><a href="#" onclick="home.leftMenu(1001)">排班列表</a></li>
            <li><a href="#" onclick="home.leftMenu(302)">待审核工单</a></li>
            <li><a href="#" onclick="home.leftMenu(303)">已审核工单</a></li>
            <li><a href="#" onclick="home.leftMenu(304)">已归档工单</a></li>
          </ul>
