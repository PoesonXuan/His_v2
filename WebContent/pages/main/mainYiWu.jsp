      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul id="treeNav" class="nav nav-sidebar">
            ...
            <li><a href="#" onclick="home.leftMenu(201)">发起工单</a></li>
            <li><a href="#" onclick="home.leftMenu(202)">处理中进度</a></li>
            <li><a href="#" onclick="home.leftMenu(203)">待归档工单</a></li>
            <li><a href="#" onclick="home.leftMenu(204)">已归档工单</a></li>
            <li><a href="#" onclick="home.leftMenu(1001)">排班列表</a></li>
          </ul>
        
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <iframe id="content" name="content" src="pages/welcome/welcome.jsp" style="width: 100%;height: 500px;border: 0;"></iframe>
        </div>
      </div>
    </div>
